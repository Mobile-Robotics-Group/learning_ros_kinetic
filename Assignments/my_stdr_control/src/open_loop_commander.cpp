...
int main(int argc, char **argv) {
    ...
    double time_3_sec = 3.14159; // should move 3 meters or 1.5 rad in 3 seconds
    ...
    twist_cmd.angular.z=yaw_rate; //and start spinning in place  LEFT
	...
	// Go forward SLIGHTLY LESS THAN 1
	twist_cmd.angular.z=0.0; //and stop spinning in place 
    twist_cmd.linear.x=speed; //and move forward again
    timer=0.0; //reset the timer
    while(timer< 0.95) {
